...
const initialWorkSlots: WorkSlot[] = [
  ...
  },
  {
    ...
    description: '茶碗の制作過程を丁寧に公開。土の準備からろくろ成形、釉薬かけ、窯入れまでの一連の工程。伝統工芸の奥深さを体感できます。',
    isOwned: false,
    isUnlocked: false,
    auctionEnded: false,
    isMyListing: false,
